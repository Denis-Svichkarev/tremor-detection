/*
 * File: _coder_extract_features_from_raw_data_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "extract_features_from_raw_data",    /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *sample_number, const char_T *identifier);
  ...
  *sample_number, const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(sample_number), &thisId);
  emlrtDestroyArray(&sample_number);
  return y;
}
  ...
  mxArray *plhs[1])
{
  ...
  real_T (*data)[600];
  real_T sample_number;
  st.tls = emlrtRootTLSGlobal;
  emlrtHeapReferenceStackEnterFcnR2012b(&st);
  emxInit_real_T(&st, &data_features, 2, true);

  /* Marshall function inputs */
  data = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "data");
  sample_number = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "sample_number");

  /* Invoke the target function */
  extract_features_from_raw_data(*data, sample_number, data_features);

  /* Marshall function outputs */
  data_features->canFreeData = false;
  plhs[0] = emlrt_marshallOut(data_features);
  emxFree_real_T(&data_features);
...
void extract_features_from_raw_data_atexit(void)
{
  ...
  extract_features_from_raw_data_xil_terminate();
  extract_features_from_raw_data_xil_shutdown();
...
/*
 * File trailer for _coder_extract_features_from_raw_data_api.c
 *
 * [EOF]
 */
