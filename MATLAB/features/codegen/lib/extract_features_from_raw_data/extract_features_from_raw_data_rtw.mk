...
## Generated on : Fri Feb 19 20:13:46 2021
...
START_DIR                 = /Users/denissvichkarev/Projects/TremorDetection/MATLAB/features/codegen/lib/extract_features_from_raw_data
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/denissvichkarev/Projects/TremorDetection/MATLAB/features -I$(MATLAB_ROOT)/extern/include
...
%.o : /Users/denissvichkarev/Projects/TremorDetection/MATLAB/features/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/denissvichkarev/Projects/TremorDetection/MATLAB/features/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
