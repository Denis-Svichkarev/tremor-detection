...
trainData = load('TremorDetection/MATLAB/model_data/TRAIN_AUD_MOV_STA.mat').TRAIN_AUD_MOV_STA;
testData = load('TremorDetection/MATLAB/model_data/TEST_AUD_MOV_STA.mat').TEST_AUD_MOV_STA;
...
% model = load('MODEL_AUD_MOV_STA').model;
...
trainData = load('TremorDetection/MATLAB/model_data/TRAIN_AUD_TRE_MOV.mat').TRAIN_AUD_TRE_MOV;
testData = load('TremorDetection/MATLAB/model_data/TEST_AUD_TRE_MOV.mat').TEST_AUD_TRE_MOV;
...
% load existing model in MATLAB
% model = load('MODEL_AUD_TRE_MOV').model;
...
saveLearnerForCoder(model, 'TremorDetection/MATLAB/models/SVM_MODEL_AUD_TRE_MOV');
save('TremorDetection/MATLAB/models/MODEL_AUD_TRE_MOV.mat', 'model');
...
trainData = load('TremorDetection/MATLAB/model_data/TRAIN_AUD_TRE_STA.mat').TRAIN_AUD_TRE_STA;
testData = load('TremorDetection/MATLAB/model_data/TEST_AUD_TRE_STA.mat').TEST_AUD_TRE_STA;
...
saveLearnerForCoder(model, 'TremorDetection/MATLAB/models/SVM_MODEL_AUD_TRE_STA');
save('TremorDetection/MATLAB/models/MODEL_AUD_TRE_STA.mat', 'model');