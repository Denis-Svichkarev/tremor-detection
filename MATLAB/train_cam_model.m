...
trainData = load('TremorDetection/MATLAB/model_data/TRAIN_CAM_TRE_STA.mat').TRAIN_CAM_TRE_STA;
testData = load('TremorDetection/MATLAB/model_data/TEST_CAM_TRE_STA.mat').TEST_CAM_TRE_STA;
...
saveLearnerForCoder(model, 'TremorDetection/MATLAB/models/SVM_MODEL_CAM_TRE_STA');
save('TremorDetection/MATLAB/models/MODEL_CAM_TRE_STA.mat', 'model');