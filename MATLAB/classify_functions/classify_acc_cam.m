...
function [label, p1, p2, p3] = classify_acc_cam(X)
	A = loadLearnerForCoder('SVM_MODEL_ACC_CAM_MOV_STA');
	B = loadLearnerForCoder('SVM_MODEL_ACC_CAM_TRE_MOV');
    C = loadLearnerForCoder('SVM_MODEL_ACC_CAM_TRE_STA');
