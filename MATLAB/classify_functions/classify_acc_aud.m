...
function [label, p1, p2, p3] = classify_acc_aud(X)
	A = loadLearnerForCoder('SVM_MODEL_ACC_AUD_MOV_STA');
	B = loadLearnerForCoder('SVM_MODEL_ACC_AUD_TRE_MOV');
    C = loadLearnerForCoder('SVM_MODEL_ACC_AUD_TRE_STA');
