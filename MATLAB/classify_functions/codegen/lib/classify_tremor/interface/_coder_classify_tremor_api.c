/*
 * File: _coder_classify_tremor_api.c
 *
...
void classify_tremor_atexit(void)
{
  ...
  classify_tremor_xil_terminate();
  classify_tremor_xil_shutdown();
...
/*
 * File trailer for _coder_classify_tremor_api.c
 *
 * [EOF]
 */
