...
static void main_classify_action();
...
static void main_classify_action()
{
  ...
  // Initialize function 'classify_action' input arguments.
  // Initialize function input argument 'X'.
  // Call the entry-point 'classify_action'.
  argInit_1x48_real_T(dv);
  classify_action(dv, label, p);
}
