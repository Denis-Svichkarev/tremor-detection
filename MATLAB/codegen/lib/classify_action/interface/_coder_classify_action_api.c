/*
 * File: _coder_classify_action_api.c
 *
...
void classify_action_atexit(void)
{
  ...
  classify_action_xil_terminate();
  classify_action_xil_shutdown();
...
/*
 * File trailer for _coder_classify_action_api.c
 *
 * [EOF]
 */
