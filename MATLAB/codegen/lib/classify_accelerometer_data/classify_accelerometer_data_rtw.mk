...
PRODUCT_NAME              = classify_accelerometer_data
MAKEFILE                  = classify_accelerometer_data_rtw.mk
MATLAB_ROOT               = /Volumes/LaCie/Applications/Matlab
MATLAB_BIN                = /Volumes/LaCie/Applications/Matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = /Users/denissvichkarev/Projects/TremorDetection/MATLAB/codegen/lib/classify_accelerometer_data
TGT_FCN_LIB               = ISO_C++
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELLIB                  = classify_accelerometer_data.a
...
PRODUCT = ./classify_accelerometer_data.a
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=classify_accelerometer_data
...
classify_accelerometer_data_data.o : $(START_DIR)/classify_accelerometer_data_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
classify_accelerometer_data_initialize.o : $(START_DIR)/classify_accelerometer_data_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


classify_accelerometer_data_terminate.o : $(START_DIR)/classify_accelerometer_data_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


classify_accelerometer_data.o : $(START_DIR)/classify_accelerometer_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
